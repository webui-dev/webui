...
[Galaxy Browser](https://github.com/galaxydo/galaxy) - interactive canvas-based knowledge management system, it allows users to write any javascript and python scripts directly on the canvas, then invoke them to be executed in Deno backend via WebUI, showing results as text and images appearing straight on the canvas.
