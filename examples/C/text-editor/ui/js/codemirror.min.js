!(function (e, t) {
		...
		if (!a) {
			...
			if (0 < v && l)
				for (var y = 0; y < l.length; ++y)
					null == l[y].to && (m = m || []).push(new Bt(l[y].marker, null, null))
					...
					w && v < 8
						...
						: ((u = (h = s.node.getBoundingClientRect()).bottom - h.top),
						  !a &&
								s.text.firstChild &&
								(c =
									s.text.firstChild.getBoundingClientRect().right - h.left - 1))
				var h,
					a = s.line.height - u
				if (
					(0.005 < a || a < -0.005) &&
	...
	function yl(e, t, n, r) {
		...
		if ((d < c && (h += we(c - d)), h != u))
			return io(o, h, F(t, 0), F(t, u.length), '+input'), !(s.stateAfter = null)
			...
			if (o.node == r) {
				...
				if (o == s)
					if (((a = !0), (o = s.childNodes[l]), (l = 0), !o))
						return Al(F(H((c = u.rest ? z(u.rest) : u.line)), c.text.length), a)
	...
	;(i.prototype.init = function (n) {
		...
		function t(e) {
			if (!A(i, e)) {
				if (i.somethingSelected()) wl({ lineWise: !1, text: i.getSelections() })
				else {
