...
int main() {
  ...
  const char *my_html =
      ...
      "    <p>Call C function with argument (<em>See the logs in your "
      "terminal</em>)</p>"
      "    <br>"
      "    <button onclick=\"webui_fn('MyID_One', 'Hello');\">Call "
      "my_function_string()</button>"
      "    <br>"
      "    <br>"
      "    <button onclick=\"webui_fn('MyID_Two', 123456789);\">Call "
      "my_function_integer()</button>"
      "    <br>"
      "    <br>"
      "    <button onclick=\"webui_fn('MyID_Three', true);\">Call "
      "my_function_boolean()</button>"
      "    <br>"
      "    <br>"
      "    <p>Call C function and wait for the response</p>"
      "    <br>"
      "    <button onclick=\"MyJS();\">Call "
      "my_function_with_response()</button>"
      "    <br>"
      "    <br>"
  ...
  // Show the window
  webui_show(my_window,
             my_html); // webui_show_browser(my_window, my_html, Chrome);
